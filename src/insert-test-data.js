...
const DESTINATIONS = [
  'Kos', 'Zakynthos', 'Rhodos', 'Magaluf', 'Split', 'Aiya Napa', 'Sunny Beach',
  'Barcelona', 'Malaga', 'Tenneriffa', 'Ibiza', 'Gotland', 'Cancun', 'Las Vegas',
  'Miami', 'Kavos', 'Torrevieja', 'Alicante', 'Albufueira', 'Marbella',
  'Valencia', 'Zagreb', 'Nice', 'Kreta', 'Monaco', 'Malta', 'Cannes',
  'Helsingfors', 'Köpenhamn', 'Berlin', 'Amsterdam', 'Milano'
];
...
async function insertTestData() {
  ...
  try {
    ...
    console.log('Successfully inserted 200 test entries');
  } catch (error) {
